...
function Empty({ className, ...props }) {
    return (_jsx("div", { "data-slot", className: cn('flex min-w-0 flex-1 flex-col items-center justify-center gap-6 rounded-lg border-dashed p-6 text-center text-balance md:p-12', className), ...props }));
}
...
function EmptyMedia({ className, variant= 'default', ...props }) {
    return (_jsx("div", { "data-slot": "empty-icon", "data-variant", className: cn(emptyMediaVariants({ variant, className })), ...props }));
}
function EmptyTitle({ className, ...props }) {
    return (_jsx("div", { "data-slot": "empty-title", className: cn('text-lg font-medium tracking-tight', className), ...props }));
}
function EmptyDescription({ className, ...props }) {
    return (_jsx("div", { "data-slot": "empty-description", className: cn('text-muted-foreground [&>a]:text-primary text-sm/relaxed [&>a]]:underline-offset-4', className), ...props }));
}
