...
function InputGroup({ className, ...props }) {
    return (_jsx("div", { "data-slot": "input-group", role, className: cn('group/input-group border-input dark:bg-input/30 relative flex w-full items-center rounded-md border shadow-xs transition-[color,box-shadow] outline-none', 'h-9 has-[>textarea]:h-auto', 'has-[>[data-align=inline-start]]]:pl-2', 'has-[>[data-align=inline-end]]]:pr-2', 'has-[>[data-align=block-start]]:h-auto has-[>[data-align=block-start]]:flex-col has-[>[data-align=block-start]]]:pb-3', 'has-[>[data-align=block-end]]:h-auto has-[>[data-align=block-end]]:flex-col has-[>[data-align=block-end]]]:pt-3', 'has-[[data-slot=input-group-control]:focus-visible]:border-ring has-[[data-slot=input-group-control]:focus-visible]:ring-ring/50 has-[[data-slot=input-group-control]:focus-visible]:ring-[3px]', 'has-[[data-slot][aria-invalid=true]]:ring-destructive/20 has-[[data-slot][aria-invalid=true]]:border-destructive dark:has-[[data-slot][aria-invalid=true]]:ring-destructive/40', className), ...props }));
}
...
function InputGroupAddon({ className, align= 'inline-start', ...props }) {
    return (_jsx("div", { role, "data-slot": "input-group-addon", "data-align", className: cn(inputGroupAddonVariants({ align }), className), onClick: (e)=> {
...
function InputGroupButton({ className, type= 'button', variant= 'ghost', size= 'xs', ...props }) {
    return (_jsx(Button, { type, "data-size", className: cn(inputGroupButtonVariants({ size }), className), ...props }));
}
