...
function ButtonGroup({ className, orientation, ...props }) {
    return (_jsx("div", { role, "data-slot": "button-group", "data-orientation", className: cn(buttonGroupVariants({ orientation }), className), ...props }));
}
...
function ButtonGroupSeparator({ className, orientation= 'vertical', ...props }) {
    return (_jsx(Separator, { "data-slot": "button-group-separator", orientation, className: cn('bg-input relative !m-0 self-stretch data-[orientation=vertical]:h-auto', className), ...props }));
}
