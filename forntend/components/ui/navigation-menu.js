...
function NavigationMenu({ className, children, viewport= true, ...props }) {
    return (_jsxs(NavigationMenuPrimitive.Root, { "data-slot": "navigation-menu", "data-viewport", className: cn('group/navigation-menu relative flex max-w-max flex-1 items-center justify-center', className), ...props, children, viewport && _jsx(NavigationMenuViewport, {})] }));
}
...
function NavigationMenuTrigger({ className, children, ...props }) {
    return (_jsxs(NavigationMenuPrimitive.Trigger, { "data-slot": "navigation-menu-trigger", className: cn(navigationMenuTriggerStyle(), 'group', className), ...props, children, ' ', _jsx(ChevronDownIcon, { className: "relative top-[1px] ml-1 size-3 transition duration-300 group-data-[state=open]:rotate-180", "aria-hidden")] }));
}
