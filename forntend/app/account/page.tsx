        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3">
              ...
              {activeTab === "profile" && (
                <div className="bg-card border border-border p-6 sm:p-8">
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="font-serif text-2xl font-semibold">Personal Information</h2>
                    ...
                    {addresses.map((address) => (
                      <div key={address.id} className="bg-card border border-border p-6 relative">
                        ...
                        <div className="mt-4 pt-4 border-t border-border flex gap-4">
                          <button className="text-sm font-medium hover:text-accent transition-colors">Edit</button>
                          <button className="text-sm font-medium text-destructive hover:text-destructive/80 transition-colors">Delete</button>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              {activeTab === "payment" && (
                <div className="bg-card border border-border p-6 sm:p-8">
                  <h2 className="font-serif text-2xl font-semibold mb-6">Payment Methods</h2>
