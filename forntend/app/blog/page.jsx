...
const featuredPost = {
  id: "1",
  title: "The Art of Traditional Bangladeshi Weaving Journey Through Time",
...
const blogPosts = [
  {
    id: "2",
    title: "Summer Style Guide Cool & Chic",
  ...
  {
    id: "3",
    title: "Sustainable Fashion Commitment to the Planet",
  ...
  {
    id: "4",
    title: "The Perfect Panjabi Complete Buying Guide",
  ...
  {
    id: "5",
    title: "Behind the Scenes Our Artisans",
  ...
  {
    id: "6",
    title: "Wedding Season Meets Modern",
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="py-16 bg-secondary/30">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="font-serif text-3xl font-semibold mb-12">Latest Articles
